<template>
    <div>
            ...
            <v-row cols="12">
                <v-col cols="6">
                    <div style="display:flex;">
                        ...
                        <String label="입력하세요." v-model="value.userName" :editMode="editMode"/>
                    </div>
                </v-col>
            </v-row>
        </div>
        ...
        <div>
            <AdressManager offline label="Adresses" v-model="value.adresses" :editMode="editMode" @change="change"/>
        </div>

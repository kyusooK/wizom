<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['userName','rankId','adresses',]" />
        ...
        <AdressesDetailGrid :selectedGrid="selectedGrid" />
        <v-col>
            <v-dialog
                v-model="openDialog"
...
import AdressesDetailGrid from './AdressesDetailGrid.vue'
...
export default {
    ...
    methods:{
        ...
        onSelectionChanged(s) {
            ...
            if (selectedItem) {
                this.selectedGrid = selectedItem.adresses;
